...
public record DatabaseInit(QuestionRepository questionRepository,
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        var question1 = new Question(0L, "Hungry?", "Are you hungry?", LocalDate.now().minus(1, ChronoUnit.DAYS),
                Set.of(new Answer(0L, user1, AnswerType.TOTALLY_AGREE), new Answer(1L, user2, AnswerType.AGREE)));
        var question2 = new Question(1L, "School is boring", "Idk i just think school is boring. I could use my time efficiently and play computer games instead...",
                LocalDate.now().plus(1, ChronoUnit.MONTHS), Set.of(new Answer(2L, user1, AnswerType.DISAGREE)));
        var question3 = new Question(1L, "Is Star Wars good?", "Hey my friends are always asking me if I already watched Star Wars. Is it really that good?", LocalDate.now().plus(1, ChronoUnit.MONTHS), Collections.emptySet());
        var question4 = new Question(1L, "Penguins are cute", "Today I was in the local zoo and I loved the penguins they have. I even took a picture of them!", LocalDate.now().plus(1, ChronoUnit.MONTHS), Collections.emptySet());
        var question5 = new Question(1L, "School is boring", "Idk i just think school is boring. I could use my time efficiently and play computer games instead...", LocalDate.now().plus(1, ChronoUnit.MONTHS), Collections.emptySet());
